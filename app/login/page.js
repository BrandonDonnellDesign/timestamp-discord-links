...
export default async function LoginPage() {
  ...
  return (
    <div
      ...
      <div
        className='absolute inset-0 z-10 items-center bg-gray-500 bg-cover bg-right bg-no-repeat lg:hidden'
        style={{ backgroundImage: 'url(https' }}>
        <div className='absolute inset-0 z-0 bg-black opacity-60'></div>
      </div>
      <div className='z-20 w-full py-6'>
        <h1 className='my-6 text-5xl font-bold'>TwitchLinker</h1>
        <div className='space-x-2 py-6'>
          <span className='inline-flex h-10 w-10 items-center justify-center rounded-full border-2 border-white text-lg font-bold'>
            {' '}
            <Image src={discordLogo} className='w-full' alt='' />
          </span>
          {/* <span className="inline-flex h-10 w-10 items-center justify-center rounded-full border-2 border-white text-lg font-bold">f</span>
      <span className="inline-flex h-10 w-10 items-center justify-center rounded-full border-2 border-white text-lg font-bold">G+</span>
      <span className="inline-flex h-10 w-10 items-center justify-center rounded-full border-2 border-white text-lg font-bold">in</span> */}
        </div>
        ...
        <form className='mx-auto w-full px-4 sm:w-2/3 lg:px-0'>
          ...
          <div className='grid grid-cols-2 gap-8 px-4 pb-2 pt-4'>
            <div>
              <button
