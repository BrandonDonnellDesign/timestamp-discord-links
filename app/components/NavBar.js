  ...
  return (
    <div className="container mx-auto px-4">
      <div className="flex items-center justify-between py-4">
        <div>
            <a href='/'><h1 className=' font-sans font-extrabold text-2xl'>TwitchLinker</h1></a>
        </div>

        <div className="hidden sm:flex sm:items-center">
          <a href="/" className="text-white text-sm font-semibold hover:text-purple-600 mr-4">Home</a>
          <a href="/generator" className="text-white text-sm font-semibold hover:text-purple-600 mr-4">Link Generator</a>
        </div>
...
{/*         <div class="hidden sm:flex sm:items-center">
      ...
      <div className="block sm:hidden bg-white border-t-2 py-2">
        <div className="flex flex-col">
          ...
          <a href="/generator" className="text-white text-sm font-semibold hover:text-purple-600 mb-1">Link Generator</a>
{/*           <div class="flex justify-between items-center border-t-2 pt-2">
            <a href="#" class="text-white text-sm font-semibold hover:text-purple-600 mr-4">Sign in</a>
            <a href="#" class="text-white text-sm font-semibold border px-4 py-1 rounded-lg hover:text-purple-600 hover:border-purple-600">Sign up</a>
          </div> */}
        </div>
      </div>
    </div>
