  ...
  return (
    <div className='container mx-auto px-4'>
      <div className='flex items-center justify-between py-4'>
        <div>
          <a href='/'>
            <h1 className=' font-sans font-extrabold text-2xl'>TwitchLinker</h1>
          </a>
        </div>
        ...
        <div className='hidden sm:flex sm:items-center'>
          {user != null ? (
            <div>
              <form action={signOut}>
                <p className='text-white text-sm font-semibold hover:text-purple-600 mr-4'>{user.email}</p>
                <button  className='text-white text-sm font-semibold hover:text-purple-600 mr-4' >Sign Out</button>
              </form>
            </div>
          ) : (
            <>
